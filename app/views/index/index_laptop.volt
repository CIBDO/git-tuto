...
{{ content() }}
      ...
      {% if (userId == 1) OR in_array("caisse_r", userPermissions) OR in_array("caisse_w", userPermissions) OR in_array("caisse_a", userPermissions) %}
      ...
      {% if (userId == 1) OR in_array("ph_r", userPermissions) OR in_array("ph_w", userPermissions) OR in_array("ph_a", userPermissions) %}
      ...
      {% if (userId == 1) OR in_array("f_r", userPermissions) OR in_array("f_w", userPermissions) OR in_array("f_a", userPermissions) %}
      ...
      {% if (userId == 1) OR in_array("dp_r", userPermissions) OR in_array("dp_w", userPermissions) OR in_array("dp_a", userPermissions) OR in_array("cs_r", userPermissions) OR in_array("cs_w", userPermissions) OR in_array("cs_a", userPermissions) %}
