<div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            {% if form_action == 'edit' %}
                {{ trans['Modifier un type de produit'] }}
            {% else %}
        ...
        {% if form_action == 'edit' %}
        <form action="{{ url('type_produit/' ~ form_action ~ 'TypeProduit/' ~ typeProduit_id) }}" class="form ajaxForm" method="post">
        {% else %}
        <form action="{{ url('type_produit/' ~ form_action ~ 'TypeProduit/') }}" class="form ajaxForm" method="post">
        {% endif %}
