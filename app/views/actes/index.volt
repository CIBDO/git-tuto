...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="{{ url('index') }}"><i class="fa fa-dashboard"></i> {{ trans['Prestations']}}</a></li>
...
<script>
    ...
    $( document ).ready(function() {
        ...
        $('body').on('click', '.editPopup', function () {
            ...
            $.ajax({
                url: "{{url('actes/editActe')}}/" + $(this).data('acte'),
                cache: false,
                async: true
            })
            .done(function( html ) {
        ...
        $('body').on('click', '.showChambre', function () {
            $.ajax({
                url: "{{url('actes/showchambre')}}/" + $(this).data('chambre'),
                cache: false,
                async: true
            })
            .done(function( html ) {
        ...
        $('body').on('click', '.deleteBtn', function () {
            ...
            swal(
                ...
                .then(function() {
                    $('body').addClass('loading');
                    $.ajax({
                        url: "{{url('actes/deleteActe')}}/" + acte_id,
                        cache: false,
                        async: true
                    })
