<div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            {% if form_action == 'edit' %}
                {{ trans["Modifier un type d'antibiogramme"] }}
            {% else %}
        ...
        {% if form_action == 'edit' %}
        <form action="{{ url('labo_antibiogrammes_type/' ~ form_action ~ 'LaboAntibiogrammesType/' ~ laboAntibiogrammesType_id) }}" class="form ajaxForm" method="post">
        {% else %}
        <form action="{{ url('labo_antibiogrammes_type/' ~ form_action ~ 'LaboAntibiogrammesType/') }}" class="form ajaxForm" method="post">
        {% endif %}
