<div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            {% if form_action == 'edit' %}
                {{ trans["Modifier une catégorie d'acte d'imagerie"] }}
            {% else %}
        ...
        {% if form_action == 'edit' %}
        <form action="{{ url('img_items_categories/' ~ form_action ~ 'ImgItemsCategories/' ~ imgItemsCategories_id) }}" class="form ajaxForm" method="post">
        {% else %}
        <form action="{{ url('img_items_categories/' ~ form_action ~ 'ImgItemsCategories/') }}" class="form ajaxForm" method="post">
        {% endif %}
