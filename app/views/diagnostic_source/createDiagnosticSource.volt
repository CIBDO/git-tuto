<div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        {% if form_action == 'edit' %}
        <form action="{{ url('diagnostic_source/' ~ form_action ~ 'DiagnosticSource/' ~ diagnosticSource_id) }}" class="form ajaxForm" method="post">
        {% else %}
        <form action="{{ url('diagnostic_source/' ~ form_action ~ 'DiagnosticSource/') }}" class="form ajaxForm" method="post">
        {% endif %}
