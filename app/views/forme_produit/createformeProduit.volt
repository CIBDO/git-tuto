<div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            {% if form_action == 'edit' %}
                {{ trans['Modifier une forme de produit'] }}
            {% else %}
        ...
        {% if form_action == 'edit' %}
        <form action="{{ url('forme_produit/' ~ form_action ~ 'FormeProduit/' ~ formeProduit_id) }}" class="form ajaxForm" method="post">
        {% else %}
        <form action="{{ url('forme_produit/' ~ form_action ~ 'FormeProduit/') }}" class="form ajaxForm" method="post">
        {% endif %}
