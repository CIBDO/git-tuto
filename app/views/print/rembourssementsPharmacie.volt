    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header">
          <input type="text" style="border: none; color: #000;font-size:18px;text-align: left;font-weight: bold; background: none;" name="titre" id="titre" size="80" value="Facture de demande de remboursement - Pharmacie">
