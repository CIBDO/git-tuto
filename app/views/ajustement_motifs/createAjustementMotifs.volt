<div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        {% if form_action == 'edit' %}
        <form action="{{ url('ajustement_motifs/' ~ form_action ~ 'AjustementMotifs/' ~ ajustementMotifs_id) }}" class="form ajaxForm" method="post">
        {% else %}
        <form action="{{ url('ajustement_motifs/' ~ form_action ~ 'AjustementMotifs/') }}" class="form ajaxForm" method="post">
        {% endif %}
