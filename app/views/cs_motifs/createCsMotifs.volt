<div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        {% if form_action == 'edit' %}
        <form action="{{ url('cs_motifs/' ~ form_action ~ 'CsMotifs/' ~ csMotifs_id) }}" class="form ajaxForm" method="post">
        {% else %}
        <form action="{{ url('cs_motifs/' ~ form_action ~ 'CsMotifs/') }}" class="form ajaxForm" method="post">
        {% endif %}
