...
{{ content() }}
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
          ...
          <h1>
            {{ trans['Tableau de bord - Imagérie']}} 
          </h1>
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-green">
                <div class="inner">
                  ...
                  <p>Nombre de demande clôturée</p>
                </div>
                <div class="icon">
                  <i class="ion ion-stats-bars"></i>
                </div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="box box-primary box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Nombre de demande par categorie </h3>
                    </div>

                    <div class="box-body">
                        <div class="table-responsive">
                            <table  id="demandeParCategorie">
                                <thead class="bg-aqua-gradient">
                                </thead>
                                <tbody>
                                </tbody>
...
<script>
  ...
  $( document ).ready(function() {
    ...
    $('#demandeParCategorie').bootstrapTable({
        data: {{ demandeParCategorie }},
        cache: false,
        striped: true,
        pagination: true,
        pageSize: 10,
