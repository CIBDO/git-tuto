                        ...
                        <form class="form-inline" role="form" action="" method="get">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group  col-md-2" style="margin-right : 10px">
                                    ...
                                    {{ select(['etat',  ['encours' : 'encours', 'création' : 'création', 'clotûré' : 'clotûré'], 'useEmpty' : false, 'class': 'form-control']) }}
                                </div>
...
<script>
    ...
    function actionsFormatter(value, row, index){
        return '<a class="btn btn-info btn-xs " href=\'{{ url("img_demandes/dossier/") }}'+row.patient_id+'\'"><i class="fa fa-fw fa-clone"></i> {{trans["Détails"]}}</a>';
    }
    ...
    $('body').on('click', '.imprimEnvelop', function () {
        ...
        window.location.href = "{{url('img_demandes/imprimEnvelop')}}/" + txtID.join(",");
