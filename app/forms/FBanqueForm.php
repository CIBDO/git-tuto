...
class FBanqueForm extends Form {
    ...
    public function initialize($trans) {
        ...
        //comptes
        $comptes = new Text('comptes', ["class" => "form-control input-md", "required" => "required"]);
        $comptes->setLabel($trans['Comptes']);
        $comptes->setFilters(array('striptags'));
        $this->add($comptes);
    }
}
