...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <?= $trans['Export de données de consultation'] ?>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= $this->url->get('index') ?>"><i class="fa fa-dashboard"></i> <?= $trans['Consultations'] ?></a></li>
                    ...
                    <div class="box-body">
                        <form class="form-inline" role="form" action="" method="get">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group  col-md-4" style="margin-right : 10px">
                                    <label for="form_id"><?= $trans['Formulaire '] ?> :</label>
                                        <?= $this->tag->selectstatic(['form_id', $forms, 'using' => ['id', 'libelle'], 'class' => 'form-control', 'id' => 'form_id', 'useEmpty' => true, 'emptyText' => 'choisir']) ?>
                                </div>
...
<script>
    ...
    function detailsFormatter(value, row, index) {
        return '<a class="btn btn-info btn-xs "href=\'<?= $this->url->get('consultation/consultation/') ?>'+row.patient_id+'\'"><i class="fa fa-fw fa-stethoscope"></i> <?= $trans['Détails'] ?></a>';
    }
