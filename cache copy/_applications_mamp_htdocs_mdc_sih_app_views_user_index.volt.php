...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<?= $this->url->get('index') ?>"><i class="fa fa-dashboard"></i> <?= $trans['Dashboard'] ?></a></li>
            ...
            <div class="col-xs-12">
                ...
                <div class="box box-widget widget-user">
                    ...
                    <div class="widget-user-image">
                      <img class="img-circle" src="<?= $this->url->get('img/user.jpg') ?>" alt="User Avatar">
                    </div>
...
<script>
    ...
    $( document ).ready(function() {
        ...
        $('body').on('click', '.createPopup', function () {
            $.ajax({
                url: "<?= $this->url->get('user/createUser') ?>",
                cache: false,
                async: true
            })
            .done(function( html ) {
        ...
        $('body').on('click', '.editPopup', function () {
            ...
            $.ajax({
                url: "<?= $this->url->get('user/editUser') ?>/" + $(this).data('user'),
                cache: false,
                async: true
            })
            .done(function( html ) {
        ...
        $('body').on('click', '.showChambre', function () {
            $.ajax({
                url: "<?= $this->url->get('user/showchambre') ?>/" + $(this).data('chambre'),
                cache: false,
                async: true
            })
            .done(function( html ) {
        ...
        $('body').on('click', '.deleteBtn', function () {
            ...
            swal(
                ...
                .then(function() {
                        $('body').addClass('loading');
                        $.ajax({
                            url: "<?= $this->url->get('user/deleteUser') ?>/" + user_id,
                            cache: false,
                            async: true
                        })
