  ...
  <div class="login-box" style="margin: 3% auto;">
    <div class="login-logo">
      <!-- <img src="<?= $this->url->get('img/logo.png') ?>" class="img-responsive"> -->
  ...
  <div class="col-md-4">
    ...
    <div class="box box-primary">
      ...
      <!-- /.box-header -->
      <!-- form start --><br>
      <form action="<?= $this->url->get('authen/login') ?>" method="post">
        <div class="box-body">
        ...
        <div class="box-footer">
          ...
          <!--<a href="<?= $this->url->get('authen/emailformpwdreset') ?>"><?= $trans['I forgot my password'] ?></a><br>-->
