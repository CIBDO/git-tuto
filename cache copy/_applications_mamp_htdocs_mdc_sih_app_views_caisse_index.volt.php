                            ...
                            <div class="row" style="margin-top : 10px">
                                <div class="col-md-12" >
                                    <div class="form-group  col-md-4">
                                        ...
                                        <?= $this->tag->textfield(['id', 'id' => 'id', 'class' => 'form-control']) ?>
                                    </div>
                                </div>
                            </div>  
                            ...
                            <div class="row" style="margin-top : 10px">
                                <div class="col-md-12" >
                                    <div class="form-group  col-md-4">
                                        ...
                                        <?= $this->tag->textfield(['prenom', 'id' => 'prenom', 'class' => 'form-control', 'required' => 'required']) ?>
                                    </div>

                                    <div class="form-group  col-md-4">
                                        <label for="nom" style="width: 100px"><?= $trans['Nom'] ?> :</label>
                                        <?= $this->tag->textfield(['nom', 'id' => 'nom', 'class' => 'form-control', 'required' => 'required']) ?>
                                    </div>

                                    <div class="form-group  col-md-4">
                                        <label for="date_naissance" style="width: 100px"><?= $trans['Naissance'] ?> :</label>
                                        <?= $this->tag->datefield(['date_naissance', 'id' => 'date_naissance', 'class' => 'form-control', 'id' => 'date_naissance', 'required' => 'required']) ?>
                                    </div>
                            ...
                            <div class="row" style="margin-top : 10px">
                                <div class="col-md-12" >
                                    <div class="form-group  col-md-4">
                                        ...
                                        <?= $this->tag->textfield(['telephone', 'id' => 'telephone', 'class' => 'form-control', 'data-inputmask' => '"mask": "99-99-99-99"', 'data-mask' => '']) ?>
                                    </div>
                                    ...
                                    <div class="form-group  col-md-4">
                                        ...
                                        <?= $this->tag->textfield(['adresse', 'id' => 'adresse', 'class' => 'form-control']) ?>
                                    </div>
                            ...
                            <div class="row" style="margin-top : 10px">
                                <div class="col-md-12" >
                                    <div class="form-group  col-md-4">
                                        ...
                                        <?= $this->tag->select(['sexe', ['m' => 'Masculin', 'f' => 'Feminin'], 'useEmpty' => true, 'class' => 'form-control', 'id' => '_sexe', 'required' => 'required']) ?>
                                    </div>

                                    <div class="form-group  col-md-4">
                                        <label for="num_quittance" style="width: 100px"><?= $trans['Quittance'] ?> :</label>
                                        <?= $this->tag->textfield(['num_quittance', 'class' => 'form-control']) ?>
                                    </div>
                                    ...
                                    <div class="form-group  col-md-4">
                                        ...
                                        <?= $this->tag->select(['type_assurance', $typeAssurancelist, 'class' => 'form-control', 'using' => ['id', 'libelle'], 'useEmpty' => true, 'id' => '_type_assurance']) ?>
                                    </div>
                            ...
                            <div class="row" style="margin-top : 10px" id="infos_assure">
                                <div class="col-md-12" >
                                    ...
                                    <div class="form-group  col-md-2">
                                        ...
                                        <?= $this->tag->textfield(['numero_assurance', 'id' => '_numero_assurance', 'class' => 'form-control', 'placeholder' => 'numero_assurance']) ?>
                                    </div>

                                    <div class="form-group  col-md-2">
                                        <label for="ogd" style="width: 100px"><?= $trans['OGD'] ?> :</label><br>
                                        <?= $this->tag->select(['ogd', ['inps' => 'inps', 'cmss' => 'cmss'], 'class' => 'form-control', 'id' => '_ogd', 'useEmpty' => true]) ?>
                                    </div>
                                    <div class="form-group  col-md-2">
                                        <label for="beneficiaire" style="width: 100px"><?= $trans['Bénéficiaire'] ?> :</label><br>
                                        <?= $this->tag->select(['beneficiaire', ['titulaire' => 'titulaire', 'enfant' => 'enfant', 'parent' => 'parent'], 'class' => 'form-control', 'id' => '_beneficiaire', 'useEmpty' => true]) ?>
                                    </div>
                                    <div class="form-group  col-md-2">
                                        <label for="autres_infos" style="width: 100px"><?= $trans['Autres infos'] ?> :</label><br>
                                        <?= $this->tag->textfield(['autres_infos', 'id' => '_autres_infos', 'class' => 'form-control', 'placeholder' => 'Autres infos']) ?>
                                    </div>

                                    <div class="form-group  col-md-2">
                                        <label for="type_assurance_taux" style="width: 100px"><?= $trans['Taux'] ?> :</label><br>
                                        <?= $this->tag->numericfield(['type_assurance_taux', 'id' => '_type_assurance_taux', 'class' => 'form-control', 'readonly' => 'readonly', 'placeholder' => 'Taux']) ?>
                                    </div>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody id="prestationList2">
                                                <tr class="todo-list"> 
                                                    ...
                                                    <td> 
                                                        <?= $this->tag->selectstatic(['s_prestataire', $prestataires, 'using' => ['id', 'nom'], 'class' => 'form-control', 'id' => 's_prestataire', 'useEmpty' => true]) ?>
                                                    </td>
                                                    <td> 
                            ...
                            <div class="row" style="margin-top : 10px">
                                <div class="col-md-12" >
                                    <div class="form-group  col-md-4 pull-right">
                                        ...
                                        <?= $this->tag->numericfield(['total', 'class' => 'form-control', 'id' => 'total', 'required' => 'required']) ?>
                                    </div>                                        
                                </div>
                            </div>
                            <div class="row" style="margin-top : 10px">
                                <div class="col-md-12" >
                                    <div class="form-group  col-md-4 pull-right">
                                        ...
                                        <?= $this->tag->numericfield(['total_reste', 'class' => 'form-control', 'id' => 'total_reste', 'required' => 'required']) ?>
                                    </div>                                        
                                </div>
                            </div>
                            ...
                            <div class="row" style="margin-top : 10px">
                                <div class="col-md-12" >
                                    <div class="form-group  col-md-4 pull-right">
                                        ...
                                        <?= $this->tag->numericfield(['total_reste_a_payer', 'class' => 'form-control', 'id' => 'total_reste_a_payer', 'required' => 'required']) ?>
                                    </div>                                        
                                </div>
                            </div>
                            ...
                            <div class="row" style="margin-top : 10px" id="div_total_difference">
                                <div class="col-md-12" >
                                    <div class="form-group  col-md-4 pull-right">
                                        ...
                                        <?= $this->tag->numericfield(['total_difference', 'class' => 'form-control', 'id' => 'total_difference', 'required' => 'required']) ?>
                                    </div>                                        
                                </div>
                            </div>
                            ...
                            <div class="row" style="margin-top : 10px">
                                <div class="col-md-12" >
                                    <div class="form-group  col-md-4 pull-right">
                                        ...
                                        <?= $this->tag->numericfield(['total_a_payer', 'class' => 'form-control', 'id' => 'total_a_payer', 'required' => 'required']) ?>
                                    </div>                                        
                                </div>
                            </div>
                            <div class="row" style="margin-top : 10px">
                                <div class="col-md-12" >
                                    <div class="form-group  col-md-4 pull-right">
                                        ...
                                        <?= $this->tag->numericfield(['montant_recu', 'class' => 'form-control', 'id' => 'montant_recu', 'required' => 'required']) ?>
                                    </div>                                        
                                </div>
                            </div>
                            <div class="row" style="margin-top : 10px">
...
$( document ).ready(function() {
    ...
    function autoloader(type_id){
        ...
        $('input.typeahead').typeahead({
            ajax: {
                url: '<?= $this->url->get('actes/ajaxCaisse') ?>/' + type,
                method: 'get',
                param: {test: type}
            },
    ...
    function autoloaderPatient(){
        $('input.typeahead_patient').typeahead({
            ajax: {
                url: '<?= $this->url->get('patients/ajaxPatient') ?>',
                method: 'get',
            },
            displayField: 'libelle',
            //scrollBar:true,
    ...
    $('body').on('change', '#_type_assurance', function () {
        ...
        if(val != ""){
            ...
            if($("#id").val() != ""){
                $.ajax({
                    url: "<?= $this->url->get('patients/getAssuranceInfos') ?>/" + $("#id").val() + "/" + assurance_id,
                    cache: false,
                    async: true
                })
                .done(function( data ) {
