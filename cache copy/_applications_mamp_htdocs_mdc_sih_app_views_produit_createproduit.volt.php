<div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <?php if ($form_action == 'edit') { ?>
        <form action="<?= $this->url->get('produit/' . $form_action . 'Produit/' . $produit_id) ?>" class="form ajaxForm" method="post">
        <?php } else { ?>
        <form action="<?= $this->url->get('produit/' . $form_action . 'Produit/') ?>" class="form ajaxForm" method="post">
        <?php } ?>
