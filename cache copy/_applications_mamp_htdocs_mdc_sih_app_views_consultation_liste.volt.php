...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <?= $trans['Liste des consultations'] ?>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= $this->url->get('index') ?>"><i class="fa fa-dashboard"></i> <?= $trans['Consultations'] ?></a></li>
            <li class="active"><i class="fa fa-circl-o"></i> <?= $trans['Liste'] ?></li>
        </ol>
    </section>
...
<script>
    ...
    $( document ).ready(function() {
        ...
        $('#table-javascript').bootstrapTable({
            ...
            <?php if (($userId == 1) || in_array('cs_w', $userPermissions) || in_array('cs_a', $userPermissions)) { ?>
                {
                    title: "<?= $trans['Détails'] ?>",
                    sortable: true,
