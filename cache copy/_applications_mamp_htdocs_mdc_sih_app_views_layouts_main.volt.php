...
<body class="hold-transition skin-blue sidebar-mini bo-body">
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <!-- Logo -->
            <a href="<?= $this->url->get('') ?>" class="logo ajax-navigation">
                <!-- mini logo for sidebar mini 50x50 pixels -->
                <!-- <img id="logo-menu" width="100%" src="<?= $this->url->get('img/logo.png') ?>" alt="logo"> -->
                                ...
                                <li id="li-container-languages">
                                    ...
                                    <ul id="ul-languages" class="menu">
                                        <li id="li-language-en" class="li-language">
                                                <img id="logo-en" class="logo-flag-language" src="<?= $this->url->get('img/flags/England.png') ?>" alt="en">
                                        ...
                                        <li id="li-language-fr" class="li-language">
                                            <img id="logo-fr" class="logo-flag-language" src="<?= $this->url->get('img/flags/France.png') ?>" alt="fr">
                        ...
                        <li class="dropdown notifications-menu" style="padding-right: 5px;">
                            ...
                            <ul class="dropdown-menu" id="dropdown-menu-user" style="overflow: hidden;">
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li>
                                            <a href="<?= $this->url->get('account/index') ?>" class="ajax-navigation">
                                        ...
                                        <li>
                                            <a href="<?= $this->url->get('authen/logout') ?>" class="ajax-navigation" id="sessionlogout">
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu ">
                    <?= $this->elements->getSidebarMenu($trans) ?>
                </ul>
            </section>
            <!-- /.sidebar -->
        </aside>
        ...
        <footer class="main-footer">
            ...
            <span><strong>Copyright &copy; 2020 <a href="#">Opsise Health</a>.</strong> Tous droits réservés .</span>
        </footer>
   ...
   $(document).on("click", '#allRead', function(event) {
            // Ajax request
            <?php if (isset($notificationsIDLists)) { ?>
                var list = "<?= $notificationsIDLists ?>";
            <?php } else { ?>
                var list = "";
            <?php } ?>
            $.ajax({
              url: "<?= $this->url->get('notifications/setNotificationsRead/') ?>"+list,
            }).done(function(data) {
    ...
    $(document).on("click", '.readOnce', function(event) {
            ...
            $.ajax({
              url: "<?= $this->url->get('notifications/setNotificationsRead/') ?>" + id,
            }).done(function(data) {
                console.log(data);
              $('#notif_container_box').html(data);
              window.location = "<?= $this->url->get('notifications/index') ?>"+"#"+id;
            });
    });
