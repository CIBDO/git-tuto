...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<?= $this->url->get('index') ?>"><i class="fa fa-dashboard"></i> <?= $trans['Consultation'] ?></a></li>
...
<script>
    ...
    function actionsFormatter(value, row, index){
        return '<a class="btn btn-info btn-xs "href=\'<?= $this->url->get('consultation/consultation/') ?>'+row.patient_id+'\'"><i class="fa fa-fw fa-flask"></i> <?= $trans['Détails'] ?></a>';
    }
