      ...
      <form action="" class="form ajaxForm" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
          <section class="col-lg-6">
            ...
            <?php if ($activeModules->modPharmacie == 1) { ?>
            <div>
                <div class="box box-primary" style="width: 100%;margin-top: 10px;">
                    ...
                    <div class="box-body">
                      <div class="form-group">
                          ...
                          <?= $this->tag->select(['pharmacie_type', ['0' => 'Gestion mono-stock', '1' => 'Gestion multi-stock'], 'useEmpty' => false, 'class' => 'form-control', 'id' => 'pharmacie_type', 'required' => 'required']) ?>
                      </div>

                      <div class="form-group">
                          <label for="default_lot" class="control-label"><?= $trans['Numéro de lot par défaut '] ?></label>
                          <?= $this->tag->textfield(['default_lot', 'class' => 'form-control']) ?>
                      </div>

                      <div class="form-group">
                          <label for="default_peremption" class="control-label"><?= $trans['Date de péremption par défaut'] ?></label>
                          <?= $this->tag->datefield(['default_peremption', 'class' => 'form-control']) ?>
                      </div>

                      <div class="form-group">
                          <label for="default_coef" class="control-label"><?= $trans['Coefficient multiplicateur par défaut'] ?></label>
                          <?= $this->tag->numericfield(['default_coef', 'class' => 'form-control']) ?>
                      </div>
            ...
            <?php if ($activeModules->modConsultation == 1) { ?>
            <div>
                <div class="box box-primary"  style="width: 100%;margin-top: 10px;">
                    <div class="box-header with-border">
                    ...
                    <div class="box-body">
                      <div class="form-group">
                          ...
                          <?= $this->tag->textfield(['default_constante', 'class' => 'form-control']) ?>
                      </div>

                      <div class="form-group">
                          <label for="default_examen" class="control-label"><?= $trans['Examens par défaut'] ?></label>
                          <i>(Format: type/libellé,type/libellé, etc...)</i>
                          <?= $this->tag->textfield(['default_examen', 'class' => 'form-control']) ?>
                      </div>

                      <div class="form-group">
                          <label for="diagnostic_source" class="control-label"><?= $trans['Source de données diagnostic'] ?></label>
                          <?= $this->tag->select(['diagnostic_source', ['ajaxCim10' => 'CIM10', 'ajaxDiagnostic' => 'Autre'], 'useEmpty' => false, 'class' => 'form-control', 'id' => 'diagnostic_source', 'required' => 'required']) ?>
                      </div>
            ...
            <?php if ($activeModules->modImagerie == 1) { ?>
            <div>
                <div class="box box-primary"  style="width: 100%;margin-top: 10px;">
                    <div class="box-header with-border">
                    ...
                    <div class="box-body">
                      <div class="form-group">
                          ...
                          <?= $this->tag->textfield(['img_msg_annonce', 'class' => 'form-control']) ?>
                      </div>

                      <div class="form-group">
                          <label for="img_msg_fin" class="control-label"><?= $trans['Message de fin de resultat'] ?></label>
                          <?= $this->tag->textfield(['img_msg_fin', 'class' => 'form-control']) ?>
                      </div>
                ...
                <div class="box box-primary" style="width: 100%;padding: 0;margin: 0;">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                          ...
                          <?= $this->tag->select(['type_entete', ['e' => 'Entête complete en image', 'l' => 'Logo + 4 lignes'], 'useEmpty' => true, 'emptyText' => 'Choisir', 'class' => 'form-control', 'id' => 'type_entete']) ?>
                      </div>

                      <div class="form-group">
                          <label for="logo" class="control-label"><?= $trans['Fichier d\'entête'] ?></label>
                          <?= $this->tag->filefield(['logo', 'class' => 'form-control']) ?>
                      </div>

                      <?php if ($logo != '') { ?>
                      <div class="form-group">
                          <img class="img-responsive pad" src="<?= $this->url->getStatic('img/structure/') ?><?= $logo ?>" alt="Logo">
                      </div>
                      <?php } ?>

                      <div class="form-group">
                          <label for="pharmacie_type" class="control-label"><?= $trans['Template d\'affichage de l\'entête'] ?></label>
                          <?= $this->tag->select(['template_logo', ['left' => 'Logo à gauche - texte à droite', 'right' => 'Logo à droite - texte à gauche', 'top' => 'Logo en haut au milieu - texte en dessous'], 'useEmpty' => true, 'emptyText' => 'Choisir', 'class' => 'form-control', 'id' => 'template_logo']) ?>
                      </div>

                      <div class="form-group">
                          <label for="ligne1" class="control-label"><?= $trans['Ligne d\'entête 1'] ?></label>
                          <?= $this->tag->textfield(['ligne1', 'class' => 'form-control']) ?>
                      </div>

                      <div class="form-group">
                          <label for="ligne2" class="control-label"><?= $trans['Ligne d\'entête 2'] ?></label>
                          <?= $this->tag->textfield(['ligne2', 'class' => 'form-control']) ?>
                      </div>

                      <div class="form-group">
                          <label for="ligne3" class="control-label"><?= $trans['Ligne d\'entête 3'] ?></label>
                          <?= $this->tag->textfield(['ligne3', 'class' => 'form-control']) ?>
                      </div>

                      <div class="form-group">
                          <label for="ligne4" class="control-label"><?= $trans['Ligne d\'entête 4'] ?></label>
                          <?= $this->tag->textfield(['ligne4', 'class' => 'form-control']) ?>
                      </div>
