                        ...
                        <form class="form-inline" role="form" action="" method="get">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group  col-md-2" style="margin-right : 10px">
                                    ...
                                    <?= $this->tag->select(['etat', ['1' => 'Validé', '0' => 'Annulé'], 'useEmpty' => false, 'class' => 'form-control']) ?>
                                </div>
...
<script>
    ...
    function montant_diffCelyFooter(data){
        var total = 0;
        for(var i = 0; i<data.length; i++){
            total = total + parseFloat(data[i].d_montant_difference, 10);
        }
        return numberFormatter(total);
    }
    function montant_percuFooter(data){
        var total = 0;
        for(var i = 0; i<data.length; i++){
            total = total + parseFloat(data[i].d_montant_percu, 10);
        }
        return numberFormatter(total);
    }
        ...
        $('#table-javascript').bootstrapTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    title: "<?= $trans['Total DIFF CELY'] ?>",
                    sortable: true,
                    align: 'right',
                    filterControl: "input",
                    formatter: amountFormatter,
                    footerFormatter: montant_diffCelyFooter
                },
                {
                    field: 'd_montant_percu',
                    title: "<?= $trans['Montant Perçu'] ?>",
                    sortable: true,
                    align: 'right',
                    filterControl: "input",
                    formatter: amountFormatter,
                    footerFormatter: montant_percuFooter
                },
                {
                    field: 'd_reste',
